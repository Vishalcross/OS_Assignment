...
#define PERCENT_A 0.67
#define PERCENT_B 0.75
#define PERCENT_C 0.6
#define PERCENT_D 0.67
...
void giveBackResource(int resourceNum,double retreivalPercent,int* resourceValues,int threadNum){
	...
	waitFail(value,"wait failed for binary semaphore for resource\n");
		...
		switch(resourceNum){
			case 0: retreivalPercent=PERCENT_A;break;
			case 1: retreivalPercent=PERCENT_B;break;
			case 2: retreivalPercent=PERCENT_C;break;
			case 3: retreivalPercent=PERCENT_D;break;
		}
